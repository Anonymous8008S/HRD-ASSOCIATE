...
const ProjectForm = ({ open, onClose, onSubmit, initial }: Props) => {
  const [form, setForm] = useState<Partial<projects>>(initial || defaultForm());
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onSubmit({ ...(form as projects), images: imageUrls });
      setForm(defaultForm());
      setImageFiles([]);
      onClose();
    } catch (err: any) {
