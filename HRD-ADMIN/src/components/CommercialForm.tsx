...
interface Props {
  open: boolean;
  onClose: () => void;
  onSubmit: (data: CommercialProperty) => void;
  initial?: CommercialProperty | null;
}
...
const defaultForm = (): Partial<CommercialProperty> => ({
  title: "",
  description: "",
  price: 0,
  location: "",
...
const CommercialForm = ({ open, onClose, onSubmit, initial }: Props) => {
  const [form, setForm] = useState<Partial<CommercialProperty>>(initial || defaultForm());
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onSubmit({ ...(form as CommercialProperty), images: imageUrls });
      setForm(defaultForm());
      setImageFiles([]);
      onClose();
    } catch (err: any) {
      ...
      <DialogContent className="bg-card border-border max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <DialogHeader>
          <DialogTitle className="font-serif gold-text">
            {initial ? "Edit Commercial Property" : "Add Commercial Property"}
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <Select
                ...
                onValueChange={(v) => setForm({ ...form, type: v as CommercialProperty["type"] })}
              >
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) => setForm({ ...form, facing: v as CommercialProperty["facing"] })}
              >
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <Button type="submit" disabled={uploading}>
              ...
              ) : initial ? "Update Commercial Property" : "Add Commercial Property"}
            </Button>
          </div>
